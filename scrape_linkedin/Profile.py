...
class Profile(ResultsObject):
    ...
    def personal_info(self):
        ...
        personal_info["summary"] = (
            text_or_default(self.soup, ".pv-about-section .pv-about__summary-text", "")
            .replace("... see more", "")
            .strip()
        )
    ...
    def experiences(self):
        ...
        jobs = all_or_default(container, "#experience-section ul .pv-position-entity")
        jobs = list(map(get_job_info, jobs))
        jobs = flatten_list(jobs)

        experiences["jobs"] = jobs

        schools = all_or_default(container, "#education-section .pv-education-entity")
    ...
    def to_dict(self):
        ...
        if (
            jobs
            and jobs[0]["date_range"]
            and "present" in jobs[0]["date_range"].lower()
        ):
